...
var POPUP_ANCHOR = ".mpageui-Popup-anchor";
var BUTTON = ".mpageui-Button";
/**
...
var CollapseGroupPage = /*#__PURE__*/function (_UIComponentPage) {
  ...
  _createClass(CollapseGroupPage, [{
    ...
    /**
     * The Collapse Group aria-label for the anchor control
     * @memberOf module:MPageFusion/testing.atomic.contentPanel.ContentPanelPage
     * @returns {Promise<string>} label
     */

  }, {
    key: "collapseGroupLabel",
    get: function get() {
      return this.driver.findElement(_seleniumWebdriver.By.css(COLLAPSE_BUTTON)).then(function (element) {
        return element.findElement(_seleniumWebdriver.By.css(POPUP_ANCHOR));
      }).then(function (element) {
        return element.findElement(_seleniumWebdriver.By.css(BUTTON));
      }).then(function (element) {
