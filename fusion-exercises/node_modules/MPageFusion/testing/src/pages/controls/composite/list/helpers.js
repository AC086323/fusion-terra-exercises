...
exports.GROUP_TYPES = exports.createPageList = exports.BUTTON_TYPES = void 0;

var _InlineListButton = _interopRequireDefault(require("./InlineListButton.page"));

var _SubListButton = _interopRequireDefault(require("./SubListButton.page"));

var _ListSelectGroup = _interopRequireDefault(require("./ListSelectGroup.page"));

var _SubList = _interopRequireDefault(require("./SubList.page"));
...
var createPageList = function createPageList(classNames, driver, selectorList, isSublist) {
  if (isSublist === void 0) {
    isSublist = false;
  }
  ...
  return classNames.map(function (className, index) {
    if (className.includes(LIST_SELECT_GROUP)) {
      return new _ListSelectGroup["default"](driver, {
        index: index,
    ...
    if (className.includes(NESTABLE_PANE)) {
      return new _SubList["default"](driver, {
        index: index,
        selectorList: selectorList
      });
    }
    ...
    if (isSublist) {
      return new _SubListButton["default"](driver, {
        index: index + 1,
        selectorList: selectorList
      });
    }

    return new _InlineListButton["default"](driver, {
      index: index,
      selectorList: selectorList
    });
