...
var _TableSubsection = _interopRequireDefault(require("./TableSubsection.page"));

var _TableRow = _interopRequireDefault(require("./TableRow.page"));

var _TableColumn = _interopRequireDefault(require("./TableColumn.page"));
...
var TablePage = /*#__PURE__*/function (_UIComponentPage) {
  _inheritsLoose(TablePage, _UIComponentPage);
  ...
  _createClass(TablePage, [{
    ...
    get: function get() {
      return (0, _List["default"])({
        list: this,
        itemPage: _TableSubsection["default"],
