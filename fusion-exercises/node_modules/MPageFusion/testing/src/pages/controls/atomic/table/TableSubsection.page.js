...
var TableSubsection = /*#__PURE__*/function (_UIComponentPage) {
  _inheritsLoose(TableSubsection, _UIComponentPage);

  function TableSubsection() {
    return _UIComponentPage.apply(this, arguments) || this;
  }

  var _proto = TableSubsection.prototype;
  ...
  _createClass(TableSubsection, [{
    ...
    /**
     * gets the subsection header icon
     * @memberOf module:MPageFusion/testing.atomic.table.TablePage.subsection
     * @returns {SvgIconPage} headerIcon
     */
