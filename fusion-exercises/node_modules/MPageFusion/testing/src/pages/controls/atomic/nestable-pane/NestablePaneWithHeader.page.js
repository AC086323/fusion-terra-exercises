...
var NestablePaneWithHeader = /*#__PURE__*/function (_UIComponentPage) {
  _inheritsLoose(NestablePaneWithHeader, _UIComponentPage);
  ...
  var _proto = NestablePaneWithHeader.prototype;
   ...
   * clicks the action
   * @memberOf module:MPageFusion/testing.atomic.panel.nestablePane.NestablePaneWithHeader
   * @returns {Promise} click action
   */
  ;

  _proto.click = function click() {
    return this._contentHeader.click();
  };
