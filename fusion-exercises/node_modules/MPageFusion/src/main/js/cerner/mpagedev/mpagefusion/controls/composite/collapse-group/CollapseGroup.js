...
class CollapseGroup extends UIComponent {
    ...
    propChangeHandlers() {
        return Object.assign({},
            ...
            {
                collapseGroupTitle: (title) => {
                    this.getChild("dropdown").setProp("title", title);
                    this.getChild("menu").setProp("title", title);
                }
            },
            {
                collapseGroupLabel: (label) => {
                    this.getChild("dropdown").setProp("label", label);
                    this.getChild("menu").setProp("label", label);
                }
            }
