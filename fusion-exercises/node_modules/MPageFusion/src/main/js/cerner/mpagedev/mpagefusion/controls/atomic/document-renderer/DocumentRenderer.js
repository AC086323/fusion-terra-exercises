...
/**
 * This method executes the iFrame onload event handler if iFrameOnLoad is set and also
 *  makes a call to resize method if shouldHideScrollbar is set to true.
 * @param {control} control - control ref object
 * @returns {undefined} This function does not return anything
 */
const execiFrameOnLoadFunc = (control) => function() {
    const iFrameOnLoad = control.getProp("iFrameOnLoad");
    const shouldHideScrollbar = control.getProp("shouldHideScrollbar");
    if(iFrameOnLoad) {
        iFrameOnLoad();
    }
                    ...
                    Object.assign(
                        {
                            ...
                            onload: execiFrameOnLoadFunc(this)
                        },
