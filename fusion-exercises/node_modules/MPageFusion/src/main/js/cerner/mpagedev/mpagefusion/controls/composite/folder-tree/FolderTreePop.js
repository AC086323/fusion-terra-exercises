...
class FolderTreePop extends UIComponent {
    ...
    afterCreate() {
        ...
        /**
         * This event listener calls the reAdjustPopupPane with current popup pane on resize to adjust the height of PopupPane.
         */
        this.on(NestablePaneRoot.EVENTS.RESIZE, () => {
            this.getChild("popup").getChild("popup").getChild("pane").reAdjustPopPane();
        });
    }
