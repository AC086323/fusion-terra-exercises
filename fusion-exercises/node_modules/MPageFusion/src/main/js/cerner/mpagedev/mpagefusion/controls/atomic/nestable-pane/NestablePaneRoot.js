...
const adjustHeight = (visiblePaneClass, control) => ({ dom }) => {
    ...
    const newHeight = `${childHeight(visiblePane || dom)}px`;
 ...
 */
class NestablePaneRoot extends UIComponent {
    /**
     * @inheritDoc
     */
    initialState() {
...
NestablePaneRoot.EVENTS = EVENTS;
export default NestablePaneRoot;
