...
const renderChildren =
    (el,
        // Props
        { content, showLeftAction, showRightAction, title, leftActionIcon, rightActionIcon, isTitleClickable, leftActionLabel, rightActionLabel },
        // Children
        { contentContainer, leftActionButton, leftAccessory, rightAccessory, rightActionButton },
        // Events
        { titleClick }) =>
        [
            ...renderAction(el, showLeftAction && leftActionIcon, leftActionButton, leftActionLabel),
            ...
            ...renderAction(el, showRightAction && rightActionIcon, rightActionButton, rightActionLabel)
        ];
...
class ContentHeader extends UIComponent {
    ...
    propChangeHandlers() {
        return {
            ...
            leftActionTitle: forwardProp(this, "title", "leftActionButton"),
            rightActionIcon: forwardProp(this, "icon", "rightActionButton"),
            rightActionLabel: forwardProp(this, "label", "rightActionButton"),
            rightActionTitle: forwardProp(this, "title", "rightActionButton")
        };
    }
