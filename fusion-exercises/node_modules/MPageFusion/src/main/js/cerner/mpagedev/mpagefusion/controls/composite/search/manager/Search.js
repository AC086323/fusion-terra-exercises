...
class Search extends UIComponent {
    ...
    initialProps() {
        return {
            ...
            inputBlurEventName: EVENTS.BLUR,
            isDisabled: false,
            isLoading: false,
    ...
    propChangeHandlers() {
        return {
            ...
            hasFocus: (hasFocus) => {
                this.getChild(CHILDREN.SEARCH_BAR).setProp("hasFocus", hasFocus);
            },
            shouldExpandSearchPane: (shouldExpandSearchPane) => {
                this.getChild(CHILDREN.SEARCH_PANE).setProp("shouldExpandSearchPane", shouldExpandSearchPane);
            },
            shouldExpandSearchPaneToRight: (shouldExpandSearchPaneToRight) => {
                this.getChild(CHILDREN.SEARCH_PANE).setProp("shouldExpandSearchPaneToRight", shouldExpandSearchPaneToRight);
            },
            searchLabel: (searchLabel) => {
                this.getChild(CHILDREN.SEARCH_BAR).setProp("searchLabel", searchLabel);
            }
        };
    }
