    ...
    propChangeHandlers() {
        return {
            ...
            searchOptions: (item) => {
                ...
                if(item.searchLabel) {
                    this.getChild(CHILDREN.SEARCH).setProp("searchLabel", item.searchLabel);
                }
            },
            selectedId: (value) => {
            ...
            selectControlClassNames: (selectControlClassNames) => {
                this.getChild(CHILDREN.SELECT).setProp("classNames", selectControlClassNames);
            },
            hasSearchFocus: (hasSearchFocus) => {
                this.getChild(CHILDREN.SEARCH).setProp("hasFocus", hasSearchFocus);
            },
            shouldExpandSearchPane: (shouldExpandSearchPane) => {
                this.getChild(CHILDREN.SEARCH).setProp("shouldExpandSearchPane", shouldExpandSearchPane);
            },
            shouldExpandSearchPaneToRight: (shouldExpandSearchPaneToRight) => {
                this.getChild(CHILDREN.SEARCH).setProp("shouldExpandSearchPaneToRight", shouldExpandSearchPaneToRight);
            }
        };
    }
    ...
    view(el, props, children, mappedChildren) {
        return el(
            "div",
            {
                class: classNames({
                    [NAMESPACE]: true,
                    [`${NAMESPACE}--selectionStacked`]: props.hasStackedSelection
                })
            },
            [
                el(
